...
Kirby::plugin('tw/transcript', [
    ...
    'translations' => [
        'en' => [
            ...
            'tw.transcript.info.importer' => 'Import a TXT or DOTE JSON transcript and review the detected segments before inserting the block into an episode.',
        ...
        'de' => [
            ...
            'tw.transcript.info.importer' => 'Importiere ein TXT- oder DOTE-JSON-Transkript und prüfe die erkannten Abschnitte, bevor du den Block in eine Episode einfügst.',
            ...
            'tw.transcript.error.noTranscript' => 'Bitte zuerst ein Transkript einfügen oder eine Datei laden.',
